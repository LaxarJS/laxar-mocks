...
Options set by the spec-test when calling `setupForWidget` will take precedence over these values.
...
This is the recommended way to setup your widget test. For this to work, *this* module's `fixtures`
export needs to be initialized with the following properties:
